...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 02, 2022 lúc 02:40 PM
...
(2, 'admin', 'admin', 'admin@gmail.com', 1, '21232f297a57a5a743894a0e4a801fc3'),
...
(242, 'user4', 'ád', 'thoai@gmail.com', 0, '2022-01-02 13:31:26', 7000000);
...
INSERT INTO `review` (`review_id`, `user_name`, `user_rating`, `user_review`, `datetime`, `id_product`) VALUES
(18, 'Thoai', 5, 'Sản Phẩm Tốt', 1641129902, 27),
(19, 'Tuyệ Vời', 5, 'Sản Phẩm Tốt', 1641130604, 4);
...
(14, 'user4', '$2y$10$c5mv4LxflfiHZT7iFwLChOnGmwW1QAE1w6DIuGSeRQdxoEJ091Z3.', 'Thành Viên Mới Haha', 'thoaipho51@gmail.com', 'Sài Gòn', '0856141268', 'e10adc3949ba59abbe56e057f20f883e'),
...
(17, 'user7', '$2y$10$TTiTHG4V4MSQICsOC5z6oujwYIqVXFeFSQOVyXjXxfssnj5.15keC', 'nguyen the trung', 'luke@gmail.com', '28 DInh Binh Ca Mau', '0849230500', '');
...
--
ALTER TABLE `hoadonshoez`
  MODIFY `id_hoadon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;
