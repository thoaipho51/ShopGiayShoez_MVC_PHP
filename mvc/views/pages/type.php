...
<div>
    <div>
      <img src="/shoez/public/images/slide/2.png" alt="Products">
    </div>
  </div>
                          ...
                          <div class="collapse" id="collapseExample">
                            <div class="card card-body" style="border:0;padding-top:0;">
                              <ul class="menu-product">
                                <li><a href="/shoez/product/type/A01" title="Adidas">Adidas</a></li>
                                <li><a href="/shoez/product/type/C02" title="Converse x Off-White">Converse x Off-White</a></li>
                                <li><a href="/shoez/product/type/C03" title="Nike x Javis Scott">Nike x Javis Scott</a></li>
                                <li><a href="/shoez/product/type/N01" title="Nike">Nike</a></li>
                                <li><a href="/shoez/product/type/O01" title="Off White">Off White</a></li>
                              </ul>
                            </div>
                          </div>
                        </li>
      ...
      <div class="col-md-9 col-sm-12 col-xs-12">
        ...
        <div class="row">
          ...
          foreach ($Type  as $item) {
            ...
            $tenGiay = $item['ten'];
            $ThanhPhan = $item['description'];
            $GiaGiay = number_format($item['gia'],0);
            $image = $item['image'];
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 col-6">
              <div class="product-block">
                <div class="product-img fade-box">
                  <a href="/shoez/detailproduct/show/$maGiay" title="Adidas EQT Cushion ADV" class="img-resize">
                    <img
                      src="/shoez/public/images/giay/anh1/$image "
                      alt="Adidas EQT Cushion ADV" class="lazyloaded">
                    <img
                      src="/shoez/public/images/giay/anh2/$image "
                      alt="Adidas EQT Cushion ADV" class="lazyloaded">
                  </a>
                ...
                <div class="product-detail clearfix">
                  <div class="pro-text">
                    <a style=" color: black; EQT Cushion ADV" inspiration pack>
                    $tenGiay
                    </a>
                  </div>
                  <div class="pro-price">
                    <p class="">$GiaGiay VNĐ</p>
                  </div>
                </div>
              </div>
            </div>
